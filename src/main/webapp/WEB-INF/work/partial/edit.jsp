...
$(function() {
	$( "#edit-date" ).datepicker( {dateFormat: 'd-m-yy'});
...
<div id="edit-dialog-form" title="Edit work log">
	<form:form class="cmxform"  id="work-edit-form" modelAttribute="work" action="" method="post">
		<fieldset>
			<legend>Please provide work details</legend>
				...
				<p>
					...
					<form:input id="edit-date" path="date" class="required o3date"/>
				</p>
				<p>
				...
				<input type="hidden" id = "myKey" name="myKey" value="${work.myKey}" />
		</fieldset>
	</form:form>
</div>