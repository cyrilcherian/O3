...
$(document).ready(function() {
	...
	$("#teamForm").validate({
				rules: {
					name:{
						remote:"/office-cube/team/${team.myKey}/validateT"
					}
			},
			messages: {name:{
...
<form:form class="cmxform"  id="teamForm" modelAttribute="team"  action="/office-cube/team/admin/update" method="post">
	<fieldset>
		<legend>Please provide team details</legend>
			...
			<input type="hidden" name="myKey" value="${team.myKey}" />
			<p>	
